        ...
        const shareData = [
            {
                ...
                href:
                    ...
                    twitterUserName,
                onclick:()=>{
                    window.open(this.href, 'Twitter', 'width=800,height=300,resizable=yes,toolbar=0,status=0'); return false},
            },
            {
                name: "fb",
                title: "Facebook",
                ...
                onclick:()=>{
                    window.open(this.href, 'Facebook', 'width=640,height=436,toolbar=0,status=0'); return false},
            },
            {
                name: "vk",
                title: "ВКонтакте",
