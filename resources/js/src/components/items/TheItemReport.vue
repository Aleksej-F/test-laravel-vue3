	...
	>
        ...
        >
            <div class="report__header">
                ...
                >сдать: {{ reports.averageExpense - getSumTasks(itemReports.tasks) }} </div>
                <div class="report__header-item"
                   v-else 
        ...
        >
            ...
            >
                <ul class="rounded-2">
                    ...
                    >Редактировать</li>
                    <li class="menu rounded-2"
                        @click.stop="deleteTask(itemReports.id)"
                    >Удалить</li>
...
const props = defineProps(["itemReports", "index", "menuVisible", "displayDetails"]);
...
const getTextDetails = computed(() => {
    return props.displayDetails ? "Скрыть" : "Подробности"
})
